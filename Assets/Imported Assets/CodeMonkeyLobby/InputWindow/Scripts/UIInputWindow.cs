...
using System;
using Imported_Assets.CodeMonkeyLobby.Stuff.CodeMonkey.Utils;
using TMPro;
using UnityEngine;

namespace Imported_Assets.CodeMonkeyLobby.InputWindow.Scripts
{
    public class UIInputWindow : MonoBehaviour {

        private static UIInputWindow instance;

        private ButtonUI okBtn;
        private ButtonUI cancelBtn;
        ...
        private void Awake() {
            ...
            okBtn = transform.Find("okBtn").GetComponent<ButtonUI>();
            cancelBtn = transform.Find("cancelBtn").GetComponent<ButtonUI>();
